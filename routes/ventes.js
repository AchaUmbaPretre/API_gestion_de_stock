...
const { getVente, postVente, deleteVente, putVente, getRetour, postRetour, deleteRetour, putRetour, getEchange, postEchange, deleteEchange, putEchange, getVenteTotalPrix, getVenteOne, getRetourOne, getEchangeOne } = require('../controllers/venteControllers');
...
router.get('/retourOne/:id',getRetourOne)
...
router.get('/echangeOne/:id',getEchangeOne)
